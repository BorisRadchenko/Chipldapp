...
let titles = ["Way Too Long TitleWithNoSpacesInIt That Would NeverEverFitAny Line",
            ...
            //"", // Нет названия
              "Obsessed By (Feat. M. Of iamthemorning)",
              "Enormously Huge Endless Title Which Seems To Be Made Up By Some Talented Young Programmer"]
let artists = ["Just Some Random Band Name",
             ...
             //"Homer J. Simpson",
              ...
              "Just Another One Fake Artist Name Made Up For Testing Purposes Only. Do Not Expect Enything Else From This Artist."]
